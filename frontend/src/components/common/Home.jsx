                ...
                <div className='container'>
                    <div className="row mb-5 pb-4">
                        ...
                        <div className="col-md-3 pb-4">
                            ...
                            <ul>
                                <li><a href="">+977-9843276470</a></li>
                                <li><a href="">mailtosushan@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="col-md-4">
                            <div className="d-flex justify-content-center py-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                    ...
                                    <path
                                        d="M0 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1zm3 0a2 2 0 0 1-2 2v4a2 2 0 0 1 2 2h10a2 2 0 0 1 2-2V6a2 2 0 0 1-2-2z"></path>
                                </svg>
                        ...
                        <div className="col-md-4">
                            <div className="d-flex justify-content-center py-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                                    ...
                                    <path
                                        d="M11 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5z"></path>
                                    <path
                                        d="M2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zm13 2v5H1V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1m-1 9H2a1 1 0 0 1-1-1v-1h14v1a1 1 0 0 1-1 1"></path>
                                </svg>
                    ...
                    <div className="row">
                        <div className="col-md-12 text-center pt-5">
                            <p>&copy; 2025 - All Rights Reserved. Sushan Paudyal </p>
                        </div>
                    </div>
                </div>
            </footer>
